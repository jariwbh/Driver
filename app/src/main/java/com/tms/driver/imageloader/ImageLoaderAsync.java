package com.tms.driver.imageloader;
...
public class ImageLoaderAsync {
	 ...
	 * @param
	 * @return {@link com.tms.driver.imageloader.ImageLoaderAsync}
	 */
		...
		if (instance == null) {
			...
			ImageLoaderConfiguration config = new ImageLoaderConfiguration.Builder(
					...
					.discCacheExtraOptions(metrics.widthPixels,
							metrics.heightPixels, CompressFormat.JPEG, 75, null)
					.threadPoolSize(3)
					// default
			...
			.cacheInMemory(true).cacheOnDisc(true).delayBeforeLoading(100)
